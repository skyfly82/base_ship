...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.systemuser.driver' => 'string',
            'auth.guards.systemuser.provider' => 'string',
            ...
            'middleware.global' => 'array',
            'middleware.aliases.auth' => 'string',
            'middleware.aliases.guest' => 'string',
            'middleware.aliases.systemuser.auth' => 'string',
            ...
            'services.inpost.api_url' => 'string',
            'services.inpost.token' => 'string',
...
'auth.guards.api.driver','auth.guards.api.provider','auth.guards.api.hash','auth.guards.systemuser.driver','auth.guards.systemuser.provider',
'auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.system_users.driver',
...
'mail.markdown.paths','middleware.global','middleware.aliases.auth','middleware.aliases.guest','middleware.aliases.systemuser.auth',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.inpost.api_url','services.inpost.token','session.driver',
...
'sanctum.csrf-cookie','shipments.index','shipments.store','shipments.show',
'shipments.update','shipments.destroy','orders.index','orders.store','orders.show','orders.update',
'orders.destroy','invoices.index','invoices.store','invoices.show','invoices.update',
'invoices.destroy',
'dashboard','profile.edit','profile.update','profile.destroy','invoices.index',
'invoices.show','shipments.index','shipments.show','shipments.create','shipments.store',
'shipments.payment','shipments.pay','shipments.label','register','login','password.request','password.email',
...
'invoices.index','invoices.show','layouts.app','layouts.guest','layouts.navigation',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','shipments.create',
'shipments.index','shipments.show','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'VITE_APP_NAME','INPOST_API_URL','INPOST_API_TOKEN',);
